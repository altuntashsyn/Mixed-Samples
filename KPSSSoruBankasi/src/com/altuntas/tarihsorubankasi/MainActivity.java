			...
			ThirdSelection.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if (sec3.equals(cevap)) {
						...
						TxtResult.setText("DoÛru Cevap SayÝsÝ= " + Result + " "
								+ "Toplam cevap sayÝsÝ" + totalresult);
		...
		BtnSonuc.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Toast.makeText(
						getApplicationContext(),
						"Toplam Cevap SayÝsÝ: " + totalresult + "\n"
								+ "Toplam DoÛru Cevap SayÝsÝ: " + resulttrue
								+ "\n" + "Toplam YanlÝß Cevap SayÝsÝ: "
